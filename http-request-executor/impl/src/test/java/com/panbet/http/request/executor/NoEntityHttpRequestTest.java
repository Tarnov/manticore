...
class NoEntityHttpRequestTest {
    ...
    {
        final Throwable t = assertThrows(IllegalArgumentException.class, () -> new NoEntityHttpRequest(null));
    ...
    @Test
    void testSuccess1() {
        final NoEntityHttpRequest request = new NoEntityHttpRequest(METHOD);
    ...
    void testMissingParams2(final HttpMethod httpMethod, final URI uri, final String message) {
        final Throwable t = assertThrows(IllegalArgumentException.class,
                () -> new NoEntityHttpRequest(httpMethod, uri));
    ...
    @Test
    void testSuccess2() {
        final NoEntityHttpRequest request = new NoEntityHttpRequest(METHOD, URII);
        assertEquals(METHOD.getName(), request.getMethod());
    ...
    @Test
    void testSuccess3() {
        final NoEntityHttpRequest request = new NoEntityHttpRequest(METHOD, URI_STRING);
        assertEquals(METHOD.getName(), request.getMethod());
