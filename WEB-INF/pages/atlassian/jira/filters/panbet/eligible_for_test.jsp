...
<table style="margin: auto">
    ...
    <tr>
        <td style="vertical-align: top; white-space: nowrap">
            <c:forEach var="priorityKey" items="${groupedByPriorityEligibleGroups.keySet()}" varStatus="number">
                <c:set var="priorityGroup" value="${groupedByPriorityEligibleGroups.get(priorityKey)}"/>
                <div>${priorityKey.getName()}</div>
                <div style="text-align : center">
                    <div style="display: inline-block; text-align: left">
                        <ul class="list-style-type-none">
                            <c:forEach var="eligibleGroup" items="${priorityGroup}">
